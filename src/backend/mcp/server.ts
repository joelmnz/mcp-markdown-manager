      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            notes: { type: 'string', description: 'Optional article notes. Returned with article reads but not versioned.' },
          },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            notes: { type: 'string', description: 'Optional article notes. Updating only notes does not create a new version.' },
          },
